...
namespace yumeami {
   ...
   * @brief Interface between a virtual RenderTexture target and the raylib window.
   * Contains information for scaling a virtual target.
   *
   */
   ...
   */
  void setup_display_manager(const RenderTexture& virtual_target,
   ...
   * @param display_manager
   */
  void draw_virtual_target_on_window(const RenderTexture& virtual_target,
